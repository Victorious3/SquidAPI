...
public class ModVersion {
	...
	public ModVersion(String modid, String minVersion, String maxVersion) {
		this.modid = modid;
		this.minVersion = minVersion.equals("*") ? Integer.MIN_VALUE : IntUtils.parseInt(minVersion);
		this.maxVersion = maxVersion.equals("*") ? Integer.MAX_VALUE : IntUtils.parseInt(maxVersion);
	}
